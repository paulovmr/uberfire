...
public class ConditionalPlaceRequestTest {
    ...
    public void defaultPlaceRequestEqualsToConditionalPlaceRequest() {
        ...
        final ConditionalPlaceRequest conditionalPlaceRequest = new ConditionalPlaceRequest( "my" ).when( p -> true ).orElse( new DefaultPlaceRequest( "other" ) );
    ...
    public void defaultPlaceRequestNotEqualsToConditionalPlaceRequest() {
        final DefaultPlaceRequest defaultPlaceRequest = new DefaultPlaceRequest( "my" );
        final ConditionalPlaceRequest conditionalPlaceRequest = new ConditionalPlaceRequest( "my" ).when( p -> false ).orElse( new DefaultPlaceRequest( "other" ) );
    ...
    public void defaultPlaceRequestEqualsToIncompleteConditionalPlaceRequest() {
        final DefaultPlaceRequest defaultPlaceRequest = new DefaultPlaceRequest( "my" );
        final ConditionalPlaceRequest conditionalPlaceRequest = new ConditionalPlaceRequest( "my" );
    ...
    public void trueEvaluatedConditionalPlaceRequestEqualsToAnotherTrueEvaluatedConditionalPlaceRequest() {
        final ConditionalPlaceRequest conditionalPlaceRequest1 = new ConditionalPlaceRequest( "place1" ).when( p -> true ).orElse( new DefaultPlaceRequest( "place2" ) );
        final ConditionalPlaceRequest conditionalPlaceRequest2 = new ConditionalPlaceRequest( "place1" ).when( p -> true ).orElse( new DefaultPlaceRequest( "place3" ) );
    ...
    public void falseEvaluatedConditionalPlaceRequestEqualsToAnotherFalseEvaluatedConditionalPlaceRequest() {
        final ConditionalPlaceRequest conditionalPlaceRequest1 = new ConditionalPlaceRequest( "place1" ).when( p -> false ).orElse( new DefaultPlaceRequest( "place2" ) );
        final ConditionalPlaceRequest conditionalPlaceRequest2 = new ConditionalPlaceRequest( "place3" ).when( p -> false ).orElse( new DefaultPlaceRequest( "place2" ) );
    ...
    public void trueEvaluatedConditionalPlaceRequestEqualsToAnotherFalseEvaluatedConditionalPlaceRequest() {
        final ConditionalPlaceRequest conditionalPlaceRequest1 = new ConditionalPlaceRequest( "place1" ).when( p -> true ).orElse( new DefaultPlaceRequest( "place2" ) );
        final ConditionalPlaceRequest conditionalPlaceRequest2 = new ConditionalPlaceRequest( "place3" ).when( p -> false ).orElse( new DefaultPlaceRequest( "place1" ) );
    ...
    public void falseEvaluatedConditionalPlaceRequestEqualsToAnotherTrueEvaluatedConditionalPlaceRequest() {
        final ConditionalPlaceRequest conditionalPlaceRequest1 = new ConditionalPlaceRequest( "place1" ).when( p -> false ).orElse( new DefaultPlaceRequest( "place2" ) );
        final ConditionalPlaceRequest conditionalPlaceRequest2 = new ConditionalPlaceRequest( "place2" ).when( p -> true ).orElse( new DefaultPlaceRequest( "place3" ) );

        equals( conditionalPlaceRequest1, conditionalPlaceRequest2 );
    }

    private void equals( final DefaultPlaceRequest placeRequest1,
                         final DefaultPlaceRequest placeRequest2 ) {
    ...
    private void notEquals( final DefaultPlaceRequest placeRequest1,
                            final DefaultPlaceRequest placeRequest2 ) {
