...
public class TreeHierarchyInternalItemPresenter implements HierarchyInternalItemPresenter {
    ...
    public void select() {
        final HierarchyItemSelectedEvent event = new HierarchyItemSelectedEvent( hierarchyElement.getId(),
                                                                                 hierarchyElement.getPortablePreference().getPojoClass(),
                                                                                 hierarchyElement.getPortablePreference() );
