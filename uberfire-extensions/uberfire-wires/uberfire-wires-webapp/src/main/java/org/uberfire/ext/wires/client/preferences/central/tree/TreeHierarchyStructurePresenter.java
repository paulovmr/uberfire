...
import org.uberfire.ext.wires.client.preferences.central.event.HierarchyItemSelectedEvent;
...
public class TreeHierarchyStructurePresenter implements HierarchyStructurePresenter {
    ...
    public void hierarchyItemSelectedEvent( @Observes HierarchyItemSelectedEvent hierarchyItemSelectedEvent ) {
        ...
        final HierarchyItemFormInitializationEvent event = new HierarchyItemFormInitializationEvent( hierarchyItemSelectedEvent.getItemId(),
                                                                                                     hierarchyItemSelectedEvent.getPreferenceClass(),
                                                                                                     hierarchyItemSelectedEvent.getPreference() );
    ...
    public String getPreferenceFormIdentifier( Class<?> preferenceClass ) {
        // TODO Search for custom form, or else return the default one.
        return DefaultPreferenceForm.IDENTIFIER;
    }
